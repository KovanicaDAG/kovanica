---
title: "HTLC / Atomic Swap — RFC-004 (Slice 5A)"
category: 60-Planning
source: protocol/docs/plans/htlc-atomic-swap.md
synced: 2026-09-26
---
...
Demo (M1.6) runbook: [[40-Node/node--ATOMIC-SWAP-DEMO|`kovanica-node/ATOMIC-SWAP-DEMO.md`]] — testnet staging plan, browser claim/refund walkthrough, and the exact/`curl`-verifiable HTTP sequence.