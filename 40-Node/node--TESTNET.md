---
title: "kovanica-testnet"
category: 40-Node
source: node/TESTNET.md
synced: 2026-09-26
---
# kovanica-testnet
...
> (genesis, subsidy, caps), see [[30-Operations/protocol--TESTNET|`protocol/TESTNET.md`]] —
> `Premine`/`Subsidy cap` rows above are pre-RFC-006 and kept only as historic reference.

Join a clone: [[40-Node/node--JOIN|JOIN.md]] (one-click install, Windows/Linux/macOS, USB stick).

## Run

See [[40-Node/node--README|README.md]].
