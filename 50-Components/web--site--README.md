...
VPS rebuild: `npm run build:vps` then rsync `.output` and `pm2 restart kovanica-web`. Do not steal ports from other apps on the box — see [[30-Operations/web--site--DEPLOY|DEPLOY.md]].
