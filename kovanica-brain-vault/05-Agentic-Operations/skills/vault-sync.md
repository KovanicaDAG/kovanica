---
name: vault-sync
description: Syncs documentation between the kovanica source project and Obsidian vault snapshots — use when syncing docs, updating CODE_INDEX, or pushing vault changes
---
