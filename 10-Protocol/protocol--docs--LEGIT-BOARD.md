---
title: "Kovanica — Legit board (P0 / P1 / P2)"
category: 10-Protocol
source: protocol/docs/LEGIT-BOARD.md
synced: 2026-09-26
---
...
Related specs: [[10-Protocol/protocol--docs--KVP|KVP.md]] · [[10-Protocol/protocol--docs--KVP-102-NativeTokens|KVP-102]] · [[10-Protocol/protocol--docs--WHAT-IS-KOVANICA|WHAT-IS-KOVANICA]] · [[10-Protocol/protocol--docs--TOKENOMICS|TOKENOMICS]]
...
- [x] Draft in-repo: [[10-Protocol/protocol--docs--WHAT-IS-KOVANICA|WHAT-IS-KOVANICA.md]]
...
- [x] Draft in-repo: [[10-Protocol/protocol--docs--TOKENOMICS|TOKENOMICS.md]] (from code constants)
...
**Done when:** HTLC is on `main` with tests; [[10-Protocol/protocol--docs--KVP|KVP.md]] status updated.
