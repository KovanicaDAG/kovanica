---
title: "RFC-002 — Native Tokens (Cardano Multi-Asset Model)"
category: 10-Protocol
source: protocol/docs/RFC-002-NativeTokens.md
synced: 2026-09-26
---
# RFC-002 — Native Tokens (Cardano Multi-Asset Model)

- **Status:** Shipped (implemented in `kovanica-state`)
- **Public standard name:** **[[10-Protocol/protocol--docs--KVP-102-NativeTokens|KVP-102]]** (see [[10-Protocol/protocol--docs--KVP|KVP registry]])
