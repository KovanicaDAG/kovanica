---
title: "What is Kovanica?"
category: 10-Protocol
source: protocol/docs/WHAT-IS-KOVANICA.md
synced: 2026-09-26
---
# What is Kovanica?
...
| **Token standard** | **[[10-Protocol/protocol--docs--KVP-102-NativeTokens|KVP-102]]** — multi-asset outputs (not ERC-20) |
...
See [[10-Protocol/protocol--docs--KVP|KVP.md]].
...
- [[10-Protocol/protocol--docs--TOKENOMICS|TOKENOMICS.md]] — subsidy, fees, KVNC vs KVP-102
- [[10-Protocol/protocol--docs--LEGIT-BOARD|LEGIT-BOARD.md]] — public roadmap to a credible project
- [[10-Protocol/protocol--docs--RFC-POA-Migration|RFC-POA-Migration.md]] — the PoA-only decision, §0 first
