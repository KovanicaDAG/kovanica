...
- [[30-Operations/protocol--HOWTO_MINE|How to Mine KVNC]] - CPU mining instructions for testnet and mainnet preparation
- [[30-Operations/protocol--HOWTO_LIGHT_NODE|How to Run a Light Node]] - Run a resource-efficient node for wallet usage and network participation
- [[30-Operations/protocol--HOWTO_GET_KVNC|How to Get KVNC Tokens]] - Acquire testnet KVNC via faucet, mining, or peer-to-peer transfer
