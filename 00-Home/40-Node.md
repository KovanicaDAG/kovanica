...
- [[40-Node/protocol--docs--patches--DEPLOY-KVP102|Deploy KVP-102 asset_id HTTP (PR #103)]]
- [[40-Node/protocol--docs--patches--KVP-102-HTTP-README|KVP-102 HTTP `asset_id`]]
- [[40-Node/protocol--docs--patches--POST-MERGE|PR #103 merged — HTTP source still needs apply]]
