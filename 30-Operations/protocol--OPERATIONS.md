---
title: "Operations runbook — `kovanica-testnet`"
category: 30-Operations
source: protocol/OPERATIONS.md
synced: 2026-09-26
---
...
> replacements live in [[10-Protocol/protocol--docs--RFC-POA-Migration|`docs/RFC-POA-Migration.md` §0]]
...
- **Soak snapshot (2026-08-31 ~09:10 UTC)** — public explorer API
  ...
  > [[10-Protocol/protocol--docs--RFC-POA-Migration|`docs/RFC-POA-Migration.md` §0.1]].
