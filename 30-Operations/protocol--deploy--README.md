---
title: "explorer.kovanica.online (nginx + certbot)"
category: 30-Operations
source: protocol/deploy/README.md
synced: 2026-09-26
---
# explorer.kovanica.online (nginx + certbot)

> **Historical bring-up doc.** This describes the original one-time setup.
> Current topology and day-to-day ops live in [[30-Operations/protocol--OPERATIONS|`../OPERATIONS.md`]]:
